...
5. [Inline HTML + plain JS over Lustre SPA](./tradeoffs/05-inline-html-over-lustre-spa.md) — ~~self-contained HTML page served from server.gleam~~ **superseded** (Phase 2 removed HTML; Phase 4 built the Lustre SPA)
