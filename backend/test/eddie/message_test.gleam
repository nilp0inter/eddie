...
pub fn system_part_to_chat_message_test() {
  ...
  let chat_messages = message_conv.to_chat_messages([msg])
...
pub fn from_chat_response_text_test() {
  ...
  let assert Ok(msg) = message_conv.from_chat_response(response)
  case msg {
...
pub fn from_chat_response_empty_choices_test() {
  ...
  message_conv.from_chat_response(response)
  |> should.be_error
}
...
pub fn multiple_messages_to_chat_messages_test() {
  ...
  let chat_messages = message_conv.to_chat_messages(messages)
