/// Eddie's own message types, decoupled from glopenai's wire format.
/// Widgets produce and consume these types. The LLM client module
/// handles conversion to/from glopenai's ChatMessage.
import gleam/list
